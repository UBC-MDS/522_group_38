...
The goal of this analysis was twofold:
...
By applying a decision tree classifier and optimizing the max depth hyperparameters, we aimed to maximize the model's predictive accuracy while maintaining interpretability. The reason a decision tree model was chosen was because of the simplicity with interpreting the decision tree as well as the low computational power to fit a decision tree model when compared to other models. 
